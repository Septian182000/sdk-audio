...
var wasmBinaryFile = "libDecodeSDK.wasm";
...
function _JPEG_Dec_Close() {
  err("missing function: JPEG_Dec_Close");
  abort(-1);
}
function _JPEG_Dec_Decode() {
  err("missing function: JPEG_Dec_Decode");
  abort(-1);
}
function _JPEG_Dec_Init() {
  err("missing function: JPEG_Dec_Init");
  abort(-1);
}
function _JPEG_Dec_Open() {
  err("missing function: JPEG_Dec_Open");
  abort(-1);
}
...
var asmLibraryArg = {
  ...
  JPEG_Dec_Close: _JPEG_Dec_Close,
  JPEG_Dec_Decode: _JPEG_Dec_Decode,
  JPEG_Dec_Init: _JPEG_Dec_Init,
  JPEG_Dec_Open: _JPEG_Dec_Open,
...
var _DECODE_GetFreePort = (Module["_DECODE_GetFreePort"] =
  createExportWrapper("DECODE_GetFreePort"));
var _DECODE_Init = (Module["_DECODE_Init"] =
  createExportWrapper("DECODE_Init"));
var _DECODE_InputOneFrame = (Module["_DECODE_InputOneFrame"] =
  createExportWrapper("DECODE_InputOneFrame"));
var _DECODE_Stop = (Module["_DECODE_Stop"] =
  createExportWrapper("DECODE_Stop"));
